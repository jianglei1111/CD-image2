...
def get_default_output_dir():
    if sys.platform == "darwin" and getattr(sys, "frozen", False):
        return os.path.join(os.path.expanduser("~/Pictures"), "CD-image2")
...
class ImageGenApp:
    ...
    def _build_ui(self):
        ...
        ttk.Label(title_box, text="CD-image2", style="Title.TLabel").pack(anchor=tk.W)

...
- `dist/Chedan-Image2-macOS.dmg` if `hdiutil` is available
- `dist/Chedan-Image2-macOS.pkg` if `pkgbuild` is available
...
- `Chedan Image2.app`
- `Chedan-Image2-macOS-app.zip`
- `Chedan-Image2-macOS.dmg`
- `Chedan-Image2-macOS.pkg`

## Use

Double-click `Chedan Image2.app`, distribute `dist/Chedan-Image2-macOS.dmg`, or install with `dist/Chedan-Image2-macOS.pkg`.
...
- Config: `~/Library/Application Support/Chedan Image2/config.ini`
- Default generated images: `~/Pictures/Chedan Image2`

...
- [Chedan-Image2-macOS.dmg](downloads/Chedan-Image2-macOS.dmg)

也可以下载其他格式：

- [Chedan-Image2-macOS.pkg](downloads/Chedan-Image2-macOS.pkg)
- [Chedan-Image2-macOS-app.zip](downloads/Chedan-Image2-macOS-app.zip)

如果 macOS 提示应用未签名，请右键应用选择 `打开`，再确认打开。运行时配置保存在 `~/Library/Application Support/Chedan Image2/config.ini`，默认输出目录是 `~/Pictures/Chedan Image2`。

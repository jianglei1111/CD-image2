...
![CD-image2 GUI](assets/CD-image2-gui.png)
...
- [CD-image2-windows.exe](downloads/CD-image2-windows.exe)
...
- [CD-image2-macOS-build-source.zip](downloads/CD-image2-macOS-build-source.zip)
...
- `dist/CD-image2-macOS.dmg`
- `dist/CD-image2-macOS.pkg`
...
- [CD-image2.zip](downloads/CD-image2.zip)
...
├── CD-image2-gui.spec                # Windows PyInstaller 配置
├── CD-image2-gui-macos.spec          # macOS PyInstaller 配置
├── requirements.txt
└── config.example.ini
```
